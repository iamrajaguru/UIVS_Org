      ...
      <nav class="navbar navbar-expand-md navbar-dark bg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown  <?php if($page=='events'){echo'active';}?>">
            ...
            <li class="nav-item  <?php if($page=='portfolio'){echo'active';}?>">
              <a class="nav-link" href="<?php if($page=='home'){echo'./sub/portfolio.php';}else{echo'./portfolio.php';}?> ">Portfolio</a>
            </li>
